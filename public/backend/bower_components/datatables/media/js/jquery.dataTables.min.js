...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Kế tiếp",sPrevious:"Trước"},sEmptyTable:"KHÔNG CÓ DỮ LIỆU",sInfo:"Đang hiển thị _START_ đến _END_ trong tổng số _TOTAL_ mục",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(tìm từ tổng số _MAX_ mục)",sInfoPostFix:"",sDecimal:"",
